...
export default function CourseCreator() {
  ...
  const addSection = () => {
    if (currentSection && currentSection.title) {
      const newSection: CurriculumSection = {
        ...
        duration: currentSection.duration || '0 phút',
  ...
  const addLesson = (sectionId: string) => {
    if (currentLesson && currentLesson.title) {
      const newLesson: CurriculumLesson = {
        ...
        duration: currentLesson.duration || '0 phút',
  ...
  const handleSubmit = async (saveAsDraft: boolean = true) => {
    ...
    try {
      ...
      } as Omit<InstructorCourse, 'id' | 'createdAt' | 'students' | 'rating' | 'revenue'>;
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Điền thông tin để tạo khóa học của bạn</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  id="title"
                  placeholder="VD: Mastering Figma từ A-Z"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Học viên sẽ học được gì từ khóa học này?</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Học viên cần có gì trước khi tham gia?</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Cấu trúc nội dung khóa học</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                    ...
                    {section.lessons.map((lesson) => (
                      <div key={lesson.id}
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          {lesson.free && (
                            <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded">Miễn phí</span>
                          )}
                        </div>
                        <Button type="button" variant="ghost" size="sm"
              ...
              <div className="border-2 border-dashed rounded-lg p-4 space-y-3">
                <h4 className="font-medium">Thêm chương mới</h4>
                <div className="flex gap-2">
                  <Input
          ...
          <div className="flex justify-end gap-3 sticky bottom-0 bg-white p-4 border-t">
            ...
            <Button onClick={() => handleSubmit(false)} disabled={loading}>
              {loading ? 'Đang xử lý...' : 'Gửi để phê duyệt'}
            </Button>
          </div>
        </div>
      </div>
