  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        {/* Category */}
        <div className="text-xs text-blue-600 font-semibold uppercase tracking-wide mb-1.5">{course.category}</div>
        ...
        {/* Instructor */}
        <p className="text-xs text-gray-500 mb-2">Giảng viên: <span className="text-gray-700 font-medium">{course.instructor}</span></p>
