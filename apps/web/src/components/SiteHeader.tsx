    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/95 backdrop-blur">
        ...
        <div className="grid items-center gap-6 py-4 lg:grid-cols-[240px_1fr_auto]">
          ...
          <div className="hidden items-center gap-6 lg:flex">
            <form
              action="/courses"
              method="get"
              className="flex w-full max-w-xl items-center gap-3 rounded-full border border-slate-200 bg-slate-50 px-5 py-2 shadow-sm"
            >
              ...
              <SearchSuggestInput
                ...
                inputClassName="w-full bg-transparent text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none"
                className="flex-1"
              />
            </form>

            <nav className="flex items-center gap-6 text-sm font-semibold text-slate-700">
              <Link href="/paths" className="hover:text-blue-700">
          ...
          <div className="hidden items-center gap-6 lg:flex">
            ...
            <div className="flex flex-col items-center gap-1 text-[10px] font-semibold text-slate-500">
      ...
      <div className="lg:hidden px-6 pb-4">
        ...
        <form
          action="/courses"
          method="get"
          className="mt-4 flex items-center gap-3 rounded-full border border-slate-200 bg-slate-50 px-4 py-2"
        >
          <svg viewBox="0 0 24 24" className="h-4 w-4 stroke-slate-400" fill="none" strokeWidth="2">
            <circle cx="11" cy="11" r="7" />
            <path d="M20 20l-3.5-3.5" strokeLinecap="round" />
