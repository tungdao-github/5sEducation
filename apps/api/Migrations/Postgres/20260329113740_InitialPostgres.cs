        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Requirements = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Language = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Price = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    FlashSalePrice = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                    FlashSaleStartsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FlashSaleEndsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Level = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ThumbnailUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    PreviewVideoUrl = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    CourseId = table.Column<int>(type: "integer", nullable: false),
                    LastLessonId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseQuestion = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ExerciseOptionA = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ExerciseOptionB = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ExerciseOptionC = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ExerciseOptionD = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ExerciseCorrectOption = table.Column<int>(type: "integer", nullable: true),
                    ExerciseExplanation = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ExercisePassingPercent = table.Column<int>(type: "integer", nullable: false, defaultValue: 80),
                    ExerciseTimeLimitSeconds = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    ExerciseMaxTabSwitches = table.Column<int>(type: "integer", nullable: false, defaultValue: 2),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LearningPathId = table.Column<int>(type: "integer", nullable: false),
                    LearningPathSectionId = table.Column<int>(type: "integer", nullable: true),
                    CourseId = table.Column<int>(type: "integer", nullable: false),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedTimeSeconds = table.Column<int>(type: "integer", nullable: false),
                    TimedOut = table.Column<bool>(type: "boolean", nullable: false),
                    TabSwitchCount = table.Column<int>(type: "integer", nullable: false),
                    AllowedTabSwitches = table.Column<int>(type: "integer", nullable: false),
                    TabViolation = table.Column<bool>(type: "boolean", nullable: false),
